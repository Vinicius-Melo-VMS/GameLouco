...
public class Modelos1 : MonoBehaviour
{
    [Header("Ground Check")]
    ...
    void ClimbLadder()
    {
        ...
        if (TouchingLadder() && !climbing && onGround)
            modolo2.instance.SetKeyUp(true, transform.position);
        else
            modolo2.instance.SetKeyUp(false);
        ...
        bool down = Physics2D.OverlapCircle(transform.position + new Vector3(0, -0.1f), checkRadius, ladderMask);
